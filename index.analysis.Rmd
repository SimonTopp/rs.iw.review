...
drive_download(as_id('https://docs.google.com/spreadsheets/d/1fHsqm74c2sp2LyZjredmHMLvS08nlfHZTxf49eNon4Y/edit?usp=sharing'), path = 'wqIndex20180807.csv', overwrite = T)


##Rename all the columns
index <- read.csv('wqIndex20180807.csv', na.string = c('','na')) %>% 
