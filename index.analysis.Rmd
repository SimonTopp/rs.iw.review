...
ggplot() + geom_sf(data = world, aes(), fill = 'gray70', color = 'gray90') + 
  geom_sf(data = index.filt.sf, aes(colour = Catv2), alpha =0.8) + 
...
ggplot() + geom_sf(data = world, aes(), fill = 'gray70', color = 'gray90') + 
  geom_sf(data = index.filt.sf, aes(colour = Year), alpha =0.9) + 
  coord_sf(ylim = c(-6000000, 8338578)) +
  theme_bw() +
