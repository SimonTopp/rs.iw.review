...
##### For version with mixed years as labels, create mixed year variable where early years are binned together.   Otherwise leave this commented out.
######
...
ggsave(filename='figures/CausalFig.png', width=3,height=3, units='in', dpi=250)
...
# Convert filtered index into spatial object and remove studies without explicity lat/long
filt.sf <- filt %>% 
  filter(!is.na(Lat)) %>% 
...
ggsave(filename='figures/Spatial.png', plot = g, width=4,height=7, units='in', dpi=350)
```
